...
const CandidateShow = () => {
  ...
  // เพิ่มการตรวจจับความกว้างหน้าจอ
  useEffect(() => {
    const handleResize = () => {
  ...
  // ปรับขนาดความสูงของรูปภาพตามประเภทอุปกรณ์ (ใช้ windowWidth แทน DeviceContext)
  ...
  return (
    <div className="flex flex-col h-screen max-h-screen bg-white">
      ...
      {/* Image Preview - ใช้ windowWidth แทน DeviceContext */}
